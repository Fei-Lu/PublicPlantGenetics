            ...
            if (opList.get(i) == 83) {//S
                ...
                if (index < 0) {
                    ...
                    if (alleleIndex < 0) {
                        ...
                        byte base = AlleleEncoder.alleleBaseByteMap.get(seq.charAt(currentAltPos));
                ...
                if (index < 0) {
                    ...
                    if (alleleIndex < 0) {
                        ...
                        tagAlleleList.get(index).setAllele(seqAllele);
                        byte base = AlleleEncoder.alleleBaseByteMap.get(seq.charAt(currentAltPos-1));
                        tagAlleleList.get(index).setBase(base);
                    }
                }
                ...
                for (int j = 0; j < length; j++) {
                    ...
                    byte seqAllele = AlleleEncoder.alleleBaseByteMap.get(seq.charAt(currentAltPos-1));
                    byte refAllele = sc.getRefAlleleByteOfSNP(chrIndex, index+sIndex);
