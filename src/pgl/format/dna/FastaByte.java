 ...
 * Higher speed, more memory cost than {@link pgl.format.dna.FastaBit}.
 * @author feilu
 */
public class FastaByte extends FastaAbstract {
    /**
     * Constructs a {@link pgl.format.dna.FastaByte} from input file. The file should be either txt format or gz format.
     * @param infileS 
     */
    ...
    /**
     * Constructs a {@link pgl.format.dna.FastaByte} from input file.
     * @param infileS
     * @param format 
     */
    ...
    /**
     * Constructs a {@link pgl.format.dna.FastaByte}
     * @param names
     * @param seqs
     * @param ids 
     */
    ...
    /**
     * Constructs a new {@link pgl.format.dna.FastaByte} from a list of them
