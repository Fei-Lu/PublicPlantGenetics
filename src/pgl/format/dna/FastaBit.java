...
public class FastaBit extends FastaAbstract {
    /**
     * Constructs a {@link pgl.format.dna.FastaBit} from input file. The file should be either txt format or gz format.
     * @param infileS 
     */
    ...
    /**
     * Constructs a {@link pgl.format.dna.FastaBit} from input file.
     * @param infileS
     * @param format 
     */
    ...
    /**
     * Constructs a {@link pgl.format.dna.FastaBit}
     * @param names
     * @param seqs
     * @param ids 
     */
    ...
    /**
     * Constructs a new {@link pgl.format.dna.FastaBit} from a list of them
