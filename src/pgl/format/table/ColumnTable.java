...
public class ColumnTable<T> extends TableAbstract<T> {
    /**
     * Constructs a {@link pgl.format.table.ColumnTable} from a file, with default delimiter of "\t"
    ...
    /**
     * Constructs a {@link pgl.format.table.ColumnTable} from a file with specified format, with default delimiter of "\t"
     * @param infileS
     * @param format 
     */
    ...
    /**
     * Constructs a {@link pgl.format.table.ColumnTable} using two dimension list of custom objects
     * @param header
     * @param cells 
     */
