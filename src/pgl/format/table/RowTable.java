...
/**
 * A row based implementation of {@link pgl.format.table.TableInterface}.
...
public class RowTable<T> extends TableAbstract<T> {
    /**
     * Constructs a {@link pgl.format.table.RowTable} from a file, with default delimiter of "\t"
    ...
    /**
     * Constructs a {@link pgl.format.table.RowTable} from a file, with a custom delimiter
     * @param infileS
     * @param delimiter 
     */
    ...
    /**
     * Constructs a {@link pgl.format.table.RowTable} from a file with specified format, with default delimiter of "\t"
     * @param infileS
     * @param format 
     */
    ...
    /**
     * Constructs a {@link pgl.format.table.RowTable} using two dimension list of custom objects
     * @param header
     * @param cells 
     */
