...
/**
 * Data structure for a list of {@link pgl.format.range.RangeVal}
 * @author feilu
 */
public class RangeVals extends RangesAbstract {
    ...
    /**
     * Constructs a {@link pgl.format.range.RangeVals} object from a list of {@link pgl.format.range.Range}
     * @param ranges 
     */
    ...
    /**
     * Constructs a {@link pgl.format.range.RangeVals} object with custom parameters
     * @param infileS
     * @param format
     */
    ...
    /**
     * Constructs a {@link pgl.format.range.RangeVals} object with default, txt file or file ending with ".gz", with a header
     * @param infileS 
     */
