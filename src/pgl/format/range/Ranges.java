...
/**
 * Data structure for a list of {@link pgl.format.range.Range}, providing functions of sorting, searching, and merging, etc.
 * @author feilu
 */
public class Ranges extends RangesAbstract {
    ...
    /**
     * Constructs a {@link pgl.format.range.Ranges} object from a list of {@link pgl.format.range.Range}
     * @param ranges 
     */
    ...
    /**
     * Constructs a {@link pgl.format.range.Ranges} object with custom parameters
     * @param infileS
     * @param format
     */
    ...
    /**
     * Constructs a {@link pgl.format.range.Ranges} object with default, txt file or file ending with ".gz", with a header
     * @param infileS 
     */
    ...
    /**
     * Write to a {@link pgl.format.range.Ranges} file of specified format
     * @param outfileS
     * @param format 
     */
    ...
    /**
     * Select ranges and write to a {@link pgl.format.range.Ranges} file with specified format
     * @param outfileS
     * @param format
     * @param ifOut 
     */
