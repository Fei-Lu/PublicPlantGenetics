...
/**
 * Data structure for a list of {@link pgl.format.range.RangeValStr}
 * @author feilu
 */
public class RangeValStrs extends RangesAbstract {
    ...
    /**
     * Constructs a {@link pgl.format.range.RangeValStrs} object from a list of {@link pgl.format.range.Range}
     * @param ranges 
     */
    ...
    /**
     * Constructs a {@link pgl.format.range.RangeValStrs} object with custom parameters
     * @param infileS
     * @param format
     */
    ...
    /**
     * Constructs a {@link pgl.format.range.RangeValStrs} object with default, txt file or file ending with ".gz", with a header
     * @param infileS 
     */
    ...
    /**
     * Write to a {@link pgl.format.range.RangeVals} file of specified format
     * @param outfileS
     * @param format 
     */
