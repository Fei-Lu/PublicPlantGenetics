...
public interface RangesInterface {
    ...
    /**
     * Return a {@link pgl.format.range.Range} object
     * @param <T>
     * @param rangeIndex
     * @return 
     */
    ...
    /**
     * Insert a {@link pgl.format.range.Range} into the list
     * @param <T> {@link pgl.format.range.Range}
     * @param rangeIndex
     * @param r 
    ...
    /**
     * Remove a {@link pgl.format.range.Range} from the list
     * @param rangeIndex 
     */
    public void removeRange (int rangeIndex);
    
    /**
     * Set a {@link pgl.format.range.Range} in the list
     * @param <T> {@link pgl.format.range.Range}
     * @param rangeIndex
     * @param r 
     * @return true if it is successful, otherwise false
    ...
    /**
     * Return total number of {@link pgl.format.range.Range} in the list
     * @return 
     */
    ...
    /**
     * Return a {@link pgl.format.range.Ranges} from a chromosome
     * @param <T>
     * @param chr
    ...
    /**
     * Return a {@link pgl.format.range.Ranges}, in which a position is contained
     * @param <T>
     * @param chr
     * @param pos
     * @return 
     ...
     * @param chr
     * @param pos
     * @return negative value if the {@link pgl.format.range.RangeInterface} does not contain the position
     */
    public int getFirstRangeIndex (int chr, int pos);
    
    /**
     * Return a {@link pgl.format.range.Ranges} with no overlap between individual range
     * @return 
     */
    public Ranges getNonOverlapRanges ();
    
    /**
     * Return a {@link pgl.format.range.Ranges} by adding another Ranges object 
     * @param <T>
     * @param rs
     * @return 
     */
    ...
    /**
     * Add another {@link pgl.format.range.Range} to the current list
     * @param <T> {@link pgl.format.range.Range}
     * @param r 
     * @return  
     */
    ...
    /**
     * Add {@link pgl.format.range.Ranges} to the current list
     * @param <T> {@link pgl.format.range.RangesInterface}
     * @param rs 
     * @return  true if it is successful, otherwise false
     */
